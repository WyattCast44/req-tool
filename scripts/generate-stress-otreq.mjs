...
const project = {
  ...
  sources: [
    {
      ...
      description: '<p>Approved system requirements baseline for stress-test traceability.</p>',
      notes: '',
      createdAt: isoDaysAgo(baseTs, 100, 1),
      modifiedAt: baseTs,
      editorName: 'A. Rivera',
  ...
  requirementSourceLinks: requirements.map((requirement, index) => ({
    id: id(960000 + index),
    requirementId: requirement.id,
    sourceId: id(950001),
    type: requirement.isDerived ? 'Derived from' : 'Cites',
    locator: `${3 + (index % 7)}.${1 + (index % 9)}.${1 + (index % 5)}`,
    rationale: '',
    notes: '',
    createdAt: requirement.createdAt,
    modifiedAt: requirement.modifiedAt,
    editorName: requirement.editorName,
  })),
